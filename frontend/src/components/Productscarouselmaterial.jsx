...
export default function Productscarouselmaterial({material}) {
      ...
      <div className="my-5 container">
        <div className="p-4 border border-secondary-subtle rounded-4">
          ...
          >
            ...
            <SwiperSlide>{image}</SwiperSlide>
            <SwiperSlide>{image}</SwiperSlide>
          <SwiperSlide><Link to={`/products/?material=${material}`}><h3 className='text-center'>View All</h3></Link></SwiperSlide>
          </Swiper>
        </div>
      </div>
    </>
